...
class Growdever {
   constructor(public id: string, public nome: string, public idade: number, public turma: number, public techs: string[], public cidade: string) {}
}
...
function create(nome: string, idade: number, turma: number, techs: string[], cidade: string): Return {
